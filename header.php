...
<body>
    ...
    <?php
    $top_header_query = "SELECT * FROM top_header";
    $top_header_result = mysqli_query($conn, $top_header_query);
    while($top_header = mysqli_fetch_array($top_header_result)){
       ?>
    ...
    <section id="top-h">
        <div class="container-fliud">
            <div class="row">
                ...
                <div class="col-lg-8">
                    <div class="top-head">
                        <p><?php echo $top_header['top_address'];?> | <a>Email Id - <?php echo $top_header['top_email'];?> </a> |
                            <a>Mobile No - <?php echo $top_header['top_mobile'];?> </a>
                        </p>
                    </div>
                </div>
